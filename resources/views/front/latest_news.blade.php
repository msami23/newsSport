                    ...
                    <div class="about-right mb-90">
                        ...
                        <div class="social-share pt-30">
                            <div class="section-tittle">
                                ...
                                <ul>
                                    <li><a href="#"><img src="{{asset('front/img/news/icon-ins.png')}}" alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('front/img/news/icon-fb.png')}}" alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('front/img/news/icon-tw.png')}}" alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('front/img/news/icon-yo.png')}}" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
