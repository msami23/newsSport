                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="{{asset('front/img/gallery/header_card.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                        ...
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{asset('front/img/gallery/footer_post1.png')}}" alt="">
                                </div>
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{asset('front/img/gallery/footer_post2.png')}}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon  |  2 hours ago</p>
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{asset('front/img/gallery/footer_post3.png')}}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon  |  2 hours ago</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            <div class="banner">
                                <img src="{{asset('front/img/gallery/body_card4.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
