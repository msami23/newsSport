        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('front.categories.update',$categories -> id)}}"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Name</label>
                                <input type="text" name="name" class="form-control" id="name"
                                       value="{{$categories -> name}}" placeholder="add name">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control" id="name"
                                       value="{{$categories -> description}}" placeholder="add Abbreviation Language">
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
