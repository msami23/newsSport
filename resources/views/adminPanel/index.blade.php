                                ...
                                <li class="has-sub">
                                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                       ...
                                       aria-expanded="false" aria-controls="components">
                                        <span class="nav-text">Languages</span> <b class="caret"></b>
                                    </a>
                                    <ul class="collapse" id="components">
                                        <div class="sub-menu">

                                            <li>
                                                <a href="{{route('admin.languages')}}">All Languages</a>
                                            </li>

                                            <li>
                                                <a href="{{route('admin.languages.create')}}">Add Languages</a>
                                            </li>
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class="collapse" id="icons">
                                        <div class="sub-menu">
                                            ...
                                            <li>
                                                <a href="{{route('front.categories.create')}}">Add Categories</a>
                                            </li>
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class="collapse" id="forms">
                                        <div class="sub-menu">
                                            ...
                                            <li>
                                                <a href="{{route('front.news')}}">All News</a>
                                            </li>

                                            <li>
                                                <a href="{{route('front.news.create')}}">Add News</a>
                                            </li>
